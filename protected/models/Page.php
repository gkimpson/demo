...
class Page extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('live', 'numerical', 'integerOnly'=>true, 'min' => 0, 'max' => 1),
			array('user_id', 'exist', 'message' => 'Are you sure this user exists?!'),
			array('title', 'length', 'max'=>3, 'message' => 'Cannot be longer than {attribute}'),
			array('content, date_published', 'safe'),
			array('title', 'filter', 'filter'=>array( $this, 'filterUpperCase' )),
	...
	public function filterUpperCase($v) {
		// Do whatever to $v.
		return strtoupper($v);
	}	
